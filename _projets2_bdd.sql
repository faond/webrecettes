...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 28 Mai 2020 à 13:36
...
(32, 'nils_le_bg.jpg', 4, NULL),
(33, 'livai.jpg', 4, NULL),
(44, 'droit1.PNG', 6, NULL);
...
CREATE TABLE IF NOT EXISTS `projets2_recette` (
  ...
  KEY `pseudo` (`pseudo`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Fiche technique recette ' AUTO_INCREMENT=32 ;
