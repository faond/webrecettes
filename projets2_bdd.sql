...
--
-- Hôte : localhost:3308
-- Généré le :  sam. 30 mai 2020 à 22:32
...
--
-- Déchargement des données de la table `projets2_comprend`
--
...
--
-- Déchargement des données de la table `projets2_etape`
--
...
CREATE TABLE `projets2_photo` (
  ...
  `cheminPhoto` varchar(100) NOT NULL DEFAULT 'nouvelle.jpg',
  `id_recette` int(11) NOT NULL,
...
INSERT INTO `projets2_photo` (`id_photo`, `cheminPhoto`, `id_recette`, `slider`) VALUES
(1, 'cupcakes.jpg', 3, 1),
(2, 'lasagnes.jpg', 2, NULL),
(3, 'mojito.jpg', 9, 1),
(4, 'limonade2.jpg', 4, NULL),
...
--
-- Déchargement des données de la table `projets2_requiert`
--
...
--
ALTER TABLE `projets2_photo`
  MODIFY `id_photo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
